...
function Accordion({
  ...
  unstyled = false,
  ...props
}: AccordionPrimitive.Root.Props & { unstyled?: boolean }) {
  return (
...
function AccordionItem({
  ...
  unstyled = false,
  ...props
}: AccordionPrimitive.Item.Props & { unstyled?: boolean }) {
  return (
...
function AccordionTrigger({
  ...
  unstyled = false,
  ...props
}: AccordionPrimitive.Trigger.Props & { unstyled?: boolean }) {
  if (unstyled) {
    return (
...
function AccordionContent({
  ...
  unstyled = false,
  ...props
}: AccordionPrimitive.Panel.Props & { unstyled?: boolean }) {
  if (unstyled) {
    return (
